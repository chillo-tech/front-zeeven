...
function GuestEdit({handleSubmit}) {
    const {register, handleSubmit: handleFormSubmit, reset, formState: {errors}} = useForm({
        ...
        defaultValues: {
            profile: {id: '', civility: '', firstName: '', lastName: '', email: '', phone: ''},
    ...
    return (
        <form onSubmit={handleFormSubmit(onSubmit)}>
            <div className="grid gap-4 md:grid-cols-2 scroll-py-44 text-md py-4">
                ...
                <div className="mb-0 grid md:grid-cols-4 gap-4">
                    <div className="md:col-span-2">
                        <label htmlFor="phoneIndex" className="form-label">Indicatif</label>
                        <div className="mt-1">
                            <select {...register("profile.phoneIndex")} id="phoneIndex">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-1">
                            <input {...register("profile.phone")} type="text"
                ...
                <div className="mb-0 flex items-end pb-3">
                    <div className="mt-1 h-100">
                        <input className="form-check-input" type="checkbox" {...register("sendInvitation")}
                               id="sendFile"/>
